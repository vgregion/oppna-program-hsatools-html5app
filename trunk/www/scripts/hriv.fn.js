...
hriv.app.run = function(){
	var that = {}, queue = [];
	
	queue.push(hriv.CareUnits.list.reload(hriv.dataStore.CareUnits.careUnits));
	queue.push(hriv.DutyUnits.list.reload(hriv.dataStore.DutyUnits.dutyUnits));
	queue.push(hriv.EmergencyUnits.list.reload(hriv.dataStore.EmergencyUnits.emergencyUnits));
